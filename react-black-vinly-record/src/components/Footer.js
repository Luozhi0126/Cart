      ...
      <div className="footer-container">
        <div className="footer-row">
            <div className="footer-col">
                <label className="footerlogo"><Link to="/"><img src="./img/logo.svg" alt="黑碟" /></Link></label>
              </div>
        <div className="footer-col">
          <h3>關於我們</h3>
          <ul>
        ...
        <div className="footer-col">
          ...
          <li><Link to="https://www.facebook.com/%E9%BB%91%E7%A2%9FBlack-Record-107251915624572"><FaFacebook/></Link></li>
          <li><Link to="/"><FaInstagram/></Link></li>
          <li><Link to="https://linevoom.line.me/user/_dT1EsalLpOL08RsK6UjVZkMcSarR7mCjmlgTTjQ?utm_medium=windows&utm_source=desktop&utm_campaign=OA_Profile"><FaLine/></Link></li>
          </ul>
        </div>
        </div>
