...
function PHomeAVin({ vinyls }) {
  return (
    <>
      ...
      <Link to="/" className="btn d-flex justify-content-center mb-13">
              ...
              <SwiperSlide key={vinyls.sid}>
                <div className="position-relative d-flex t-ph-first-mx200">
                  ...
                  <div className="t-first-card bg-black">
                    ...
                    <Link to="/">
                      <div className="mx-10">
                        <div className="lh-base mb-5 height-two t-text-36">
                          {vinyls.vr_name}
                        </div>
                        <div className="text-26 lh-sm height-two text-gray">
