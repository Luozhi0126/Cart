...
function MMPassWord({password}) {
  return (
    <div className="container ">
    <div className="row">

    <div className="Link d-flex h3">
    <li className="list-unstyled  me-5"><Link to="/MEdit" className='mlisthover'>編輯資料</Link></li>
    <li className="list-unstyled  me-1"><Link to="/MPassword" className='mlisthover'>設定密碼</Link></li>
 </div>
